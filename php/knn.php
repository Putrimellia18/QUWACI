...
<html>
    ...
    <body>
        ...
        <div class="row">
            <div class="col-md-8 col-lg-9 gx-0 p-0">
                <nav class="nav nav-underline nav-fill">
                    <a class="nav-link active" href="knn.php">KNN</a>
                    <a class="nav-link" href="svm.php">SVM</a>
                    <a class="nav-link" href="random.php">RF</a>
                </nav>
                <div id="map"></div>
            </div>
            <div class="row-sm col-md-4 col-lg-3 legenda">
                <?php require "../page/sidemenu.html";?>
            </div>
        </div>
        <?php require "../page/footer.html";?>
        ...
        <script type="text/javascript">
            ...
            if ($result = mysqli_query($conn, "SELECT * FROM koordinat LEFT JOIN kualitas ON kualitas.id_kualitas=koordinat.id_kualitas"))
            {
                ...
                {?>
                    ...
                    {?>
                        ...
                        marker.bindPopup("Stasiun : <?=$row[0]?><br> Status Kualitas Air : <?=$row[1]?> <br> Keterangan : <?=$row[8]?>
                    ...
                    {?>
                        ...
                        marker.bindPopup("Stasiun : <?=$row[0]?><br> Status Kualitas Air : <?=$row[1]?>
